...
func (o *VolumeDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[DELETE /apps/{app_name}/volumes/{volume_id}] Volume_delete", response, response.Code())
	}
}
...
func (o *VolumeDeleteOK) Error() string {
	return fmt.Sprintf("[DELETE /apps/{app_name}/volumes/{volume_id}][%d] volumeDeleteOK  %+v", 200, o.Payload)
}
...
func (o *VolumeDeleteOK) GetPayload() *models.Volume {
	return o.Payload
}
