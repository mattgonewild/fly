...
func (o *VolumesListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /apps/{app_name}/volumes] Volumes_list", response, response.Code())
	}
}
...
func (o *VolumesListOK) Error() string {
	return fmt.Sprintf("[GET /apps/{app_name}/volumes][%d] volumesListOK  %+v", 200, o.Payload)
}
